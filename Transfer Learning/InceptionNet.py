...
filepath = root_path + '/Model/InceptionNet for Dataset6/model-{epoch:02d}-{val_accuracy:.2f}.h5'
...
model_path = os.path.join(root_path, 'Model/InceptionNet for Dataset6')
weight_path = model_path + '/InceptionNet_model_accuracy_' + str(train_acc).replace('.', ',') + '%.h5'     #e.g. ../Model/model_accuracy_90%.h5
json_path = model_path + '/InceptionNet_model_accuracy_' + str(train_acc).replace('.', ',') + '%.json'
